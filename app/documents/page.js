...
const ThinkingIndicator = () => (
  <div className="flex items-center gap-3">
    <div className="relative w-9 h-9">
      <div className="absolute inset-0 rounded-2xl bg-[#0077B6]/10 animate-ping" />
      <div className="relative w-9 h-9 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-center justify-center">
        <div className="flex items-end gap-1">
          <span className="w-1.5 h-1.5 rounded-full bg-[#0077B6] animate-bounce [animation-delay:-0.2s]" />
          <span className="w-1.5 h-2 rounded-full bg-[#0077B6]/80 animate-bounce" />
          <span className="w-1.5 h-2.5 rounded-full bg-[#0077B6]/60 animate-bounce [animation-delay:0.2s]" />
        </div>
      </div>
    </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-3xl px-6 py-5 shadow-2xl flex items-center gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="w-20 h-1 rounded-full bg-slate-700 overflow-hidden">
                <span className="block h-full w-1/2 bg-sky-400/80 animate-[loadingbar_1.4s_ease-in-out_infinite]" />
              </span>
      ...
      >
        <div className="p-6">
          ...
          <button
            ...
            className="w-full bg-white hover:shadow-lg text-slate-700 font-medium p-3 border border-slate-200 rounded-xl flex items-center gap-3 transition-all duration-150 group active:scale-95"
          >
        ...
        <div className="flex-1 overflow-y-auto px-4 custom-scrollbar">
          ...
          {loadingChats ? (
            <div className="space-y-3 px-2 opacity-60">
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="text-xs font-medium text-slate-600 hover:text-[#0077B6] hover:bg-white p-2 rounded-lg transition-all text-center active:scale-95"
            >
              Billing
            </button>
            <button
              onClick={handleSignOut}
              className="text-xs font-medium text-slate-600 hover:text-red-600 hover:bg-white p-2 rounded-lg transition-all text-center active:scale-95"
            >
              Log Out
            </button>
          </div>
            ...
            <div className="w-full max-w-3xl flex flex-col items-center">
              {messages.length < 2 && !image && (
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <button
                    onClick={() =>
                      setInput('Can I cool chili from 135F to 70F in 3 hours?')
                    }
                    className="bg-white hover:bg-blue-50 hover:border-blue-200 text-slate-600 text-xs px-4 py-3 rounded-xl border border-slate-200 shadow-sm transition-all text-left flex items-center gap-2 active:scale-[0.98]"
                  >
              ...
              {image && (
                <div className="bg-white/90 backdrop-blur p-2 rounded-xl shadow-lg border border-slate-100 mb-2 flex items-center gap-3">
                ...
                <div className="flex items-center p-2 w-full">
                  ...
                  <div className="relative shrink-0">
                    <button
                      ...
                      className="p-3 rounded-full hover:bg-slate-100 text-slate-400 hover:text-[#0077B6] transition-all active:scale-95"
                    >
                      <Icons.Plus />
                    </button>
                    {showModeMenu && (
                  ...
                  <button
                    ...
                    className={`p-2 shrink-0 rounded-full transition-all duration-200 ml-2 ${
                      input.trim() || image
                        ? 'bg-[#0077B6] text-white shadow-md hover:shadow-lg hover:scale-105 active:scale-95'
