      ...
      <div className="w-full max-w-sm bg-white/70 backdrop-blur-3xl backdrop-saturate-200 border border-white/50 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.2)] p-8 rounded-[2rem] relative ring-1 ring-white/60">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-2 bg-transparent text-slate-400 font-medium">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F5F5F7] font-sans text-slate-900 selection:bg-[#1E96FC]/30 selection:text-[#0A2463] flex flex-col relative overflow-x-hidden max-w-[100vw]">
      {/* Liquid glass watercolor background */}
      <div className="bg">
        <img
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-center pt-32 pb-12 gap-12 lg:gap-20 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-[#0A2463] tracking-tight leading-[1.1] mb-6 drop-shadow-sm">
            ...
            <br className="hidden md:block" /> The Health Department Arrives.
          </h2>

          <p className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed max-w-xl mb-8 opacity-90">
            protocol<span className="text-[#1E96FC] font-bold">LM</span> gives your team instant
            answers from <strong>Washtenaw, Wayne, and Oakland County</strong> rules, preventing
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              >
                ...
                <p className="text-[11px] text-slate-600 font-medium leading-tight opacity-80">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <style jsx global>{`
        ...
        /* Liquid glass meadow background + lens */
        html,
        body {
          height: 100%;
          min-height: 500vh;
