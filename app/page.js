  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-xs font-bold text-[#3E7BFA] uppercase tracking-[0.2em] mb-4 mt-2 text-center">
          protocolLM
        </h3>
        ...
        <ul className="space-y-4 mb-8 flex-1 border-t border-white/10 pt-6">
          <li className="flex items-start gap-3 text-sm font-medium text-white/90">
            <Icons.Check color="text-[#3E7BFA]" /> Unlimited Compliance Queries
          </li>
          <li className="flex items-start gap-3 text-sm font-medium text-white/90">
            <Icons.Check color="text-[#3E7BFA]" /> AI Visual Inspections (Image Mode)
          </li>
          <li className="flex items-start gap-3 text-sm font-medium text-white/90">
            <Icons.Check color="text-[#3E7BFA]" /> Full Washtenaw & FDA Database
          </li>
          <li className="flex items-start gap-3 text-sm font-medium text-white/90">
            <Icons.Check color="text-[#3E7BFA]" /> Mock Audit & Emergency Protocols
          </li>
          <li className="flex items-start gap-3 text-sm font-medium text-white/90">
            <Icons.Check color="text-[#3E7BFA]" /> <span className="text-[#3E7BFA]">Location License</span> (Unlimited Users)
          </li>
        </ul>
