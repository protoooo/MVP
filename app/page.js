...
import { MessageSquare, Send, Shield, FileText, Info, Menu, X, AlertTriangle } from 'lucide-react';
    ...
    <>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#374151', fontSize: '14px', lineHeight: '1.8', marginBottom: '25px' }}>
              ...
              <p style={{ marginBottom: '15px' }}>
                You are solely responsible for verifying all information with official sources and consulting with qualified professionals when needed.
              </p>

              <h3 style={{ fontWeight: 'bold', marginBottom: '10px', color: '#1f2937' }}>4. Limitation of Liability</h3>
              <p style={{ marginBottom: '15px' }}>
                <strong>We are NOT liable for any fines, violations, penalties, business losses, or damages</strong> of 
                any kind arising from your use of this service.
              </p>

              <h3 style={{ fontWeight: 'bold', marginBottom: '10px', color: '#1f2937' }}>5. AI-Generated Responses</h3>
              <p style={{ marginBottom: '0' }}>
                Responses are generated by artificial intelligence and may contain errors. Always verify critical information with official regulatory sources.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', gap: '15px', marginTop: '30px' }}>
              ...
              <button onClick={handleAcceptTerms} style={{ flex: 1, padding: '15px', borderRadius: '8px', border: 'none', backgroundColor: '#5D4037', color: 'white', fontWeight: '600', cursor: 'pointer', fontSize: '16px' }}>I Accept These Terms</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="app-container">
        ...
        <div className={`sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
          ...
          {/* (REMOVED: Mini File List was here) */}
          ...
          <div style={{ marginTop: '20px', padding: '10px', borderTop: '1px solid #2a436b' }}>
            <p style={{ fontSize: '10px', color: '#94a3b8', lineHeight: '1.4', fontStyle: 'italic' }}>
              This is an informational tool. Not affiliated with any government agency. 
              <button 
