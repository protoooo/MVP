        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto items-start">
          ...
          <div className="group bg-white border border-slate-200 rounded-xl p-8 hover:border-[#022c22]/30 transition-all duration-300 flex flex-col relative h-full">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-sm font-bold text-[#022c22] uppercase tracking-widest mb-2">Starter</h2>
                <p className="text-slate-500 text-xs font-medium">Single location basic access</p>
              </div>
              <IconCircle />
            </div>
            
            <div className="flex items-baseline mb-8">
              <span className="text-5xl font-bold text-slate-900 tracking-tighter">$19</span>
            ...
            <div className="flex-1 space-y-5 mb-12">
              {['100 Queries / Month', '10 Image Analyses', 'State & Federal Code Access', 'Email Support'].map((item, i) => (
                <div key={i} className="flex items-center text-sm text-slate-600 font-medium">
                  <div className="w-1.5 h-1.5 bg-slate-300 rounded-full mr-3 group-hover:bg-[#022c22] transition-colors"></div>
                  {item}
                </div>
              ))}
            </div>
            ...
            <button 
              ...
              className="w-full bg-white hover:bg-slate-50 text-slate-600 hover:text-[#022c22] font-bold py-4 rounded-lg transition-all duration-300 disabled:opacity-50 text-xs uppercase tracking-widest border border-slate-200 hover:border-[#022c22]"
            >
              {loadingId === 'price_1SWzz2DlSrKA3nbAR2I856jl' ? 'Processing...' : 'Start Trial'}
            </button>
          </div>

          {/* STANDARD CARD ($49) - Thicker border */}
          <div className="group bg-white border-2 border-[#022c22]/20 rounded-xl p-8 hover:border-[#022c22] transition-all duration-300 flex flex-col relative h-full">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-sm font-bold text-[#022c22] uppercase tracking-widest mb-2">Standard</h2>
                <p className="text-slate-500 text-xs font-medium">Enhanced intelligence</p>
              </div>
              <IconCube />
            </div>
          ...
          {/* ENTERPRISE CARD ($99) - Heaviest border & fill button */}
          <div className="group bg-white border-4 border-[#022c22] rounded-xl p-8 shadow-2xl shadow-teal-900/20 transition-all duration-300 flex flex-col relative h-full transform lg:-translate-y-2">
