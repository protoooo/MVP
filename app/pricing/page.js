    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <button onClick={() => router.push('/')} className="flex items-center space-x-2 group">
            ...
            <div>
              ...
              {/* Underline - Raspberry */}
              <div className="h-0.5 w-full bg-[#BE123C] rounded-full mt-0.5"></div>
            </div>
          </button>
          {!isAuthenticated && (
            <button 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          {!isAuthenticated && (
            <div className="mt-6 p-4 bg-rose-50 border border-[#BE123C] rounded-xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          {/* Pro Plan - Raspberry */}
          <div className="relative bg-white rounded-2xl border-2 border-[#BE123C] shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            <div className="absolute top-0 right-0 bg-[#BE123C] text-white text-xs font-bold tracking-wide px-4 py-1.5 rounded-bl-xl">
              MOST POPULAR
            </div>
            <div className="p-8">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <svg className="w-4 h-4 text-[#BE123C] mr-2.5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="w-full bg-[#BE123C] hover:bg-[#9F1239] text-white font-semibold py-3.5 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
          ...
          {/* Enterprise Plan - White with Raspberry Borders */}
          <div className="relative bg-white rounded-2xl border-2 border-slate-200 shadow-md overflow-hidden hover:shadow-lg hover:border-[#BE123C] transition-all duration-300">
            <div className="p-8">
              ...
              <button 
                ...
                disabled={loadingId !== null}
                className="w-full bg-white border-2 border-[#BE123C] text-[#BE123C] hover:bg-rose-50 font-semibold py-3.5 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
