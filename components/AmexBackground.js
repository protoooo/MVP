    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          width: '40%',
          height: '60%',
          background: 'radial-gradient(ellipse, rgba(60, 60, 80, 0.12) 0%, transparent 65%)',
          opacity: 0.5,
      ...
      <div 
        ...
        style={{
          ...
          width: '45%',
          height: '55%',
          background: 'radial-gradient(ellipse, rgba(80, 100, 130, 0.1) 0%, transparent 70%)',
          opacity: 0.4,
      ...
      <div 
        style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(90deg, rgba(255, 255, 255, 0.02) 0%, transparent 5%, transparent 95%, rgba(255, 255, 255, 0.02) 100%)',
          opacity: 0.6
        }}
      />
    </div>
