...
export default function TermsAcceptanceModal({ isOpen, onAccept, onDecline, userEmail }) {
  ...
  return (
    <>
      ...
      >
        <div 
          className="bg-white rounded-2xl shadow-2xl w-full flex flex-col my-8"
          style={{ 
            maxWidth: '48rem',
            maxHeight: '90vh',
            position: 'relative',
          ...
          <div className="flex-1 overflow-hidden" style={{ minHeight: 0 }}>
            {activeTab === 'terms' ? (
              ...
              >
                ...
                <div className="mt-6 p-4 bg-slate-50 border border-slate-200 rounded-lg mb-8">
          ...
          <div className="p-6 border-t border-slate-200 space-y-3 flex-shrink-0">
            <label className="flex items-start gap-3 cursor-pointer group">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-slate-300 text-slate-900 focus:ring-slate-500 disabled:opacity-50 cursor-pointer"
              />
