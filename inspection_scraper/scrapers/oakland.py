"""
Oakland County specific scraper implementation.
...
class OaklandScraper(BaseScraper):
    ...
    def __init__(self, delay: int = 3):
        ...
        config = configs.get('oakland', {})
        super().__init__('oakland', config, delay)
