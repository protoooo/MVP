...
// ✅ NOW ACCEPTS HEADERS OBJECT (already resolved)
export function validateCSRF(request) {
  const method = (request?.method || 'GET').toUpperCase()
  
  // Skip validation for non-API GET requests (pages)
  ...
  // Use headers directly from request object (Next.js 15 already resolved it)
