// lib/csrfProtection.js - Enhanced CSRF protection
...
export function validateCSRF(request) {
  ...
  // Block known bot patterns (basic protection)
  ...
  // Additional check: Content-Type should be application/json for API calls
...
/**
 * HOC to wrap API routes with CSRF protection
 */
