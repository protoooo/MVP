...
export const emails = {
  ...
  async sendPurchaseConfirmation(customerEmail, customerName, accessCode, amountPaid) {
    ...
    const content = `
      ...
      <p style="color: #334155; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        Thank you for your purchase! Your payment of <strong>$${amountPaid.toFixed(2)}</strong> has been received.
      </p>
      ...
      <ul style="color: #475569; font-size: 15px; line-height: 1.8; margin: 0 0 24px 20px; padding-left: 0;">
        <li style="margin-bottom: 8px;">Up to 1 hour of video processing</li>
        ...
        <li style="margin-bottom: 8px;">Frame-by-frame violation detection</li>
      ...
      <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 4px; padding: 16px; margin: 24px 0;">
        <p style="color: #92400e; font-size: 14px; line-height: 1.6; margin: 0;">
          <strong>Important:</strong> Your access code is valid for one-time use. After processing your video, you can still access and download your report using this code, but you cannot process another video with it.
        </p>
      </div>
      ...
      <p style="color: #64748b; font-size: 13px; line-height: 1.5; margin: 24px 0 0 0; padding-top: 16px; border-top: 1px solid #e2e8f0;">
        ...
        Product: Pre-Inspection Video Analysis<br>
    ...
    const html = emailTemplate({
      ...
      preheader: `Access code ${accessCode} – Start analyzing your restaurant video`,
      content,
