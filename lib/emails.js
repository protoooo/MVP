...
// FIXED: All emails changed to support@protocollm.org
...
export const emails = {
  ...
  trialEndingSoon: async (userEmail, userName, daysLeft) => {
    ...
    const html = emailTemplate({
      ...
      preheader: daysLeft === 0 ? 'Last chance to subscribe' : `Only ${daysLeft} day${daysLeft > 1 ? 's' : ''} left`,
      content,
      ctaText: 'Subscribe Now',
      ctaUrl: APP_URL,
      footerNote: daysLeft === 0 
