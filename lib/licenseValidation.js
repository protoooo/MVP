// lib/licenseValidation.js - FIXED: Exports all required functions
...
export async function validateSingleLocation(userId, sessionInfo = {}) {
  try {
    // Check if user is whitelisted first (skip validation for enterprise)
...
/**
 * Alias for logLocationAccess - used by SessionGuard
