...
async function runMatchDocuments({ supabase, queryEmbedding, filterScope, filterSector, threshold, fetchCount, label }) {
  // Note: filter_sector is intentionally omitted as match_documents RPC doesn't support it
  // All documents are already food_safety sector, so no filtering needed
