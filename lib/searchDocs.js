...
export async function searchDocuments(query, countyOrScope = 'michigan', topK = 20, sectorId = null) {
  ...
  try {
    ...
    // Determine sector: explicit sectorId takes precedence, then derive from county for backward compatibility
    const effectiveSector = sectorId || getSectorFromCounty(countyOrScope)
