// lib/usage.js - SINGLE UNLIMITED PLAN VERSION (Sonnet 4.5)
// Extended trial conversion grace period + Stripe verification
...
/**
 * ✅ Extended grace period from 15 minutes to 60 minutes
 */
async function verifyTrialExpiration(sub, userId) {
  ...
  // ✅ Verify with Stripe + extended grace period
  try {
    ...
    const FALLBACK_GRACE_MINUTES = 30 // ✅ 30-minute fallback
...
export async function logUsageForAnalytics(payload) {
  ...
  // ✅ SINGLE PLAN - Always "unlimited" with Sonnet 4.5
